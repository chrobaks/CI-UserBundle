...
<div class="container">
    <div class="row">
        <div class="col-md-12"><h3 class="page-header"><?=$tplTitle.' / '.$tplData['tutorial_title'];?></h3></div>
    </div>
    ...
    <div class="row">
        <div class="col-md-12 content-wrapper" data-clone-source="content_<?=$col['id'];?>"><?=html_entity_decode($col['content'], ENT_COMPAT, 'UTF-8');?></div>
    </div>
    <?php if(userAccessRootExists($sessionUser)):?>
    <div class="row">
        <div class="col-md-12 toolbar toolbar-form">
            <ul class="listrow clearfix">
                <li>
                    <div class="well well-sm">
                        <a data-act="deletecontent" data-val="<?=$col['id'];?>" data-toggle="confirmation" data-placement="top" title="<?=lang('label_content_delete'); ?>?">
                ...
                <li>
                    <div class="well well-sm">
                        ...
                        <?=bootstrapSelectNumber(
                            ['start'=>1,'end'=>$tplData['maxContentsZIndex'][$col['tutorial_chapter_id']]],
...
<div class="modal fade" id="myModalChapter" tabindex="-1" role="dialog" aria-labelledby="myModalChapter">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?=form_open('tutorial/createcontent',['id'=>'formNewchapter','class'=>'formAjaxRequest chapter','data-decode'=>'content']);?>
            <input type="hidden" name="tutorial_chapter_id" value="<?=$tplData['tutorial_chapter_id'];?>">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <input type="number" name="zIndex" class="data-scope" value="<?=($tplData['maxContentsZIndex'][$tplData['tutorial_chapter_id']]+1);?>" min="1" max="<?=($tplData['maxContentsZIndex'][$tplData['tutorial_chapter_id']]+1);?>">
                </div>
                <div class="form-group">
...
<div class="modal fade" id="myModalEditContent" tabindex="-1" role="dialog" aria-labelledby="myModalEditContent">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <?=form_open('tutorial/updatecontent',['id'=>'formUpdateChapter','class'=>'formAjaxRequest chapter','data-decode'=>'content']);?>
